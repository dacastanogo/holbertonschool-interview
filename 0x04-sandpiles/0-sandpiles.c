...
/**
 * tupple - excecutes one step tupple sand without modify grid1
 * @grid: grid to analize
 * @tmp: how much to add to grid sand
 * Return: no return
 *
 */
...
/**
 * stable - checks if the grid is stable
 * @grid: grid to analize
